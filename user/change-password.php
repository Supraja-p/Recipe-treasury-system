...
$query=mysqli_query($con,"select ID from tbldonor where ID='$uid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbldonor set Password='$newpassword' where ID='$uid'");
...
<!DOCTYPE html>
<head>
<title>Recipe Treasury System | Change Password  </title>

            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Search Results Against the keyword "<?php echo $search;?>"</h3>
                    </div>
                </div>
            </div>
...
<?php
$ret=mysqli_query($con,"select recipeTitle,recipePicture,id from  tblrecipes where recipeTitle like '%$search%'");

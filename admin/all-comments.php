...
<!DOCTYPE html>
<head>
<title>Recipe Treasury System | All Comments </title>
 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
$ret=mysqli_query($con,"SELECT tblrecipes.recipeTitle,tblrecipes.id as rid, tblcomments.* FROM `tblcomments` join tblrecipes on tblrecipes.id=tblcomments.recipeId");
$cnt=1;
          ...
          <tr data-expanded="true">
            ...
            <td><?php  echo $row['userName'];?></td>
              ...
              <td><?php $status=$row['status'];?>
               <?php if($status==''):?>
                <button class="btn btn-warning btn-xs">Waiting for Approval</button>
               <?php elseif($status=='0'): ?>

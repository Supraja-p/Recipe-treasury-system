...
<!DOCTYPE html>
<head>
<title>Recipe Treasury System | New Comments </title>
 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <?php
$ret=mysqli_query($con,"SELECT tblrecipes.recipeTitle,tblrecipes.id as rid, tblcomments.* FROM `tblcomments` join tblrecipes on tblrecipes.id=tblcomments.recipeId where tblcomments.status is null");
$cnt=1;
        ...
        <tbody>
          <tr data-expanded="true">
            ...
            <td><?php  echo $row['userName'];?></td>
              ...
              <td><button class="btn btn-warning btn-xs">Waiting for Approval</button></td>
                  ...
                  <td>
                    ...
                    <a href="new-comments.php?action=reject&&cid=<?php echo $row['id']; ?>"  title="Reject this comment" onclick="return confirm('Do you really want to reject this comment?');" class="btn btn-danger btn-xs">Reject </a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>

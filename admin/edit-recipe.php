...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "update tblrecipes set recipeTitle='$recipetitle',recipePrepTime='$recipeprep',recipeCookTime='$recipecooktime',recipeYields='$yields',recipeIngredients='$fitemarray',recipeDescription='$description',recipePicture='$foodpic' where id='$recipeid'");
...
<!DOCTYPE html>
<head>
<title>Recipe Treasury System   | Edit Recipe Details </title>
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <img src="../user/images/<?php  echo $row['recipePicture'];?>" width="300"><br /><br />

How to run the Recipe Treasury System Using PHP and MySQL
...
6. For Recipe Recommendation Portal to work, necessary python packages are mentioned in requirements.txt. 

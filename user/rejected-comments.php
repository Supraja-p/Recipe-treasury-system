...
$ret=mysqli_query($con,"SELECT tblrecipes.recipeTitle,tblrecipes.id as rid, tblcomments.* FROM `tblcomments` join tblrecipes on tblrecipes.id=tblcomments.recipeId where tblcomments.status='0' and  tblrecipes.userId='$uid'");
$cnt=1;
